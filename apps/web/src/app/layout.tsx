...
export const metadata: Metadata = {
  title: "Connected? - Who is connected to who?",
  ...
  keywords: ["six degrees of separation", "celebrity connections", "visual proof", "photo connections", "social graph", "connected"],
  authors: [{ name: "Connected?" }],
  openGraph: {
    title: "Connected? - Who is connected to who?",
